...
<form class="kt-form" method="POST" action="{{route('mails.store')}}">
    ...
    <div class="kt-portlet__body">
        <div class="form-group validated">
            ...
            <input name="title" type="text" value="{{old('title')}}" class="form-control   @error('title') is-invalid @enderror " id="inputSuccess1">
