		...
		<ul class="kt-menu__nav ">
			<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="index.html"
					class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
						...
						</svg></span><span class="kt-menu__link-text">{{__('Dashboard')}}</span></a></li>
			...
			<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open" aria-haspopup="true"
				...
				<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
					...
					<span class="kt-menu__link-text"> Newsletters</span>
				...
				<div class="kt-menu__submenu ">
					...
					<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('newsletters.create')}}" class="kt-menu__link "><i
							class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
							class="kt-menu__link-text text-white">créer</span></a></li>

					<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('newsletters.index')}}" class="kt-menu__link "><i
									class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
									class="kt-menu__link-text text-white">lister</span></a></li>
					</ul>
				</div>
			...
			<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
				<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
					...
					<span class="kt-menu__link-text">Mails</span>
					<i class="kt-menu__ver-arrow la la-angle-right"></i>
				</a>
				...
				<div class="kt-menu__submenu ">
					...
					<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('mails.create')}}" class="kt-menu__link ">
								<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
									class="kt-menu__link-text text-white">créer</span></a>
						</li>
					<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('mails.index')}}" class="kt-menu__link "><i
									class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
									class="kt-menu__link-text text-white">lister</span></a></li>
					</ul>
				</div>
			...
			<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
				...
				<div class="kt-menu__submenu ">
					...
					<li class="kt-menu__item  " aria-haspopup="true"><a href="{{route('components.create')}}" class="kt-menu__link ">
								<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
									class="kt-menu__link-text text-white">créer</span></a>
						</li>
					<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('components.index')}}" class="kt-menu__link "><i
									class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
									class="kt-menu__link-text text-white">lister</span></a></li>
					</ul>
				</div>
			...
			<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
				<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
					...
					<span class="kt-menu__link-text">Inscrits</span>
					{{-- <i class="kt-menu__ver-arrow la la-angle-right"></i> --}}
				</a>
			</li>
			...
			<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
				<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
					...
					<span class="kt-menu__link-text">Statistiques</span>
					{{-- <i class="kt-menu__ver-arrow la la-angle-right"></i> --}}
				</a>
			</li>
