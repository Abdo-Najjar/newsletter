<!-- begin:: Content -->
	...
	<div class="row">
				...
				<div class="kt-portlet__head kt-portlet__head--noborder kt-portlet__space-x">
					...
					<div class="kt-portlet__head-toolbar">
						...
						<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
							...
							<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/general/dropdown-menu-2","page":"index"}]/-->
							<ul class="kt-nav">
							...
							<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/general/dropdown-menu-2","page":"index"}]/-->
						</div>
					</div>
				</div>
				...
				<div class="kt-portlet__head kt-portlet__space-x">
					...
					<div class="kt-portlet__head-toolbar">
						...
						<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
							...
							<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/general/dropdown-menu-1","page":"index"}]/-->
							<ul class="kt-nav">
								<li class="kt-nav__item">
									<a href="#" class="kt-nav__link">
							...
							<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/general/dropdown-menu-1","page":"index"}]/-->
						</div>
					</div>
				</div>
		...
		<div class="col-xl-8 order-lg-2 order-xl-1">
			...
			<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/list/latest-orders","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/list/latest-orders","page":"index"}]/-->
		</div>
		<div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">

			<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/general/blog","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/general/blog","page":"index"}]/-->
		</div>
	</div>
	...
	<div class="row">
		<div class="col-xl-8 col-lg-12 order-lg-3 order-xl-1">
			...
			<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/general/best-sellers","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/general/best-sellers","page":"index"}]/-->
		</div>
		<div class="col-xl-4 col-lg-6 order-lg-3 order-xl-1">

			<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/general/new-users","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/general/new-users","page":"index"}]/-->
		</div>
		...
		<div class="col-xl-4 col-lg-6 order-lg-3 order-xl-1">
			...
			<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/general/tasks","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/general/tasks","page":"index"}]/-->
		</div>
		<div class="col-xl-4 col-lg-6 order-lg-3 order-xl-1">

			<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/general/notifications","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/general/notifications","page":"index"}]/-->
		</div>
		<div class="col-xl-4 col-lg-6 order-lg-3 order-xl-1">
